...
function SvgGraphic(DomElement) {
    this.paper = null;
    this.domId = null;
...
function SvgElement(Graphic, TypeSvgElement) {
...
//  Объект SVG Path
function SvgPath(Graphic, StringPath) {
...
//  Объект SVG Круг
function SvgCircle(Graphic, X, Y, Radius) {
...
SvgCircle.prototype.AnimateRadius = function(TargetRadius) {
    var currentRadius = parseInt(this.Element.getAttribute('r'));
    if (currentRadius < TargetRadius) {
        this.Element.setAttribute('r', currentRadius + 1);
        var self = this;
        window.requestAnimFrame(function() {
...
//  Объект SVG Текст
function SvgText(Graphic, X, Y, Text) {
...
function SvgLinearGradient(Graphic, ArrayColors) {
    var self = this;
    self.uniqId = null;
...
function SvgRadialGradient(Graphic, ArrayColors) {
    var self = this;
    self.uniqId = null;
